...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6">
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[minmax(0,1fr)_minmax(360px,520px)]">
      <div className="max-w-xl rounded-xl border border-ink/10 bg-white p-5 shadow-sm">
      ...
      <section className="rounded-xl border border-ink/10 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <h2 className="mt-1 font-display text-lg font-bold text-ink">Frontend logo</h2>
            <p className="mt-1 text-sm font-semibold leading-6 text-ink/50">
              This logo appears in the public header, footer, login pages, app shell, admin shell, and email templates.
            </p>
          </div>
          <div className="rounded-lg border border-ink/10 bg-[#fbfaf6] px-4 py-3">
          ...
          {isLoadingBranding ? (
            ...
            <dl className="grid gap-2 text-sm">
              <div className="flex items-center justify-between gap-4">
                ...
                <dd className="truncate text-right font-extrabold text-ink">
